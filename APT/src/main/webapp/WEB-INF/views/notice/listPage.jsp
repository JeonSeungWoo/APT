        ...
        <div class="contents_inner">
          <div class="conWrap proud_list">
            ...
            <table class="listTable1 bdt2s333 mt20"summary="번호,지역,제목,작성자,등록일,공감별점" >
              ...
              <tbody>
                ...
                <tr>
                  <td><span class="tdNum">${list.nno}</span></td>
                  <td class="listSubject">
                   <a href="/notice/read?page=${param.page}&nno=${list.nno}" class="tableSubject">
                      ${list.title}
                    </a>
                  </td>
         ...
         <div class="pagingBoxWrap">
          ...
          <c:if test="${login.userid ne null}">
           ...
           <a href="/notice/insertPage" id="insertBtn" class="blackBtn">등록</a>
           </div>
          </c:if>
